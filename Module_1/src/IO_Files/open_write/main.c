...
// References: https://man7.org/linux/man-pages/man2/open.2.html and https://man7.org/linux/man-pages/man2/write.2.html
...
int main(int argc, char const *argv[]) {
    ...
    fd = open(pathName, flags, mode); // Open or create a file
